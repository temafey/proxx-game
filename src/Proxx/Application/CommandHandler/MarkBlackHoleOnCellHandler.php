...
class MarkBlackHoleOnCellHandler implements CommandHandlerInterface
{
     ...
     */
    public function handle(CommandInterface $markBlackHoleOnCellCommand): void
    {
		$boardEntity = $this->entityFactory->createInstance($markBlackHoleOnCellCommand->getProcessUuid(), $markBlackHoleOnCellCommand->getUuid(), $markBlackHoleOnCellCommand->getPositionX(), $markBlackHoleOnCellCommand->getPositionY());
